...
public class HorizontalselectedView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        selectedColor = tta.getColor(R.styleable.HorizontalselectedView_HorizontalselectedViewSelectedTextColor, context.getResources().getColor(R.color.F8C450));
...
//            LogUtils.i("HorizontalselectedView------------------------------->" + strings.get(n));
            ...
            for (int i = 0; i < strings.size(); i++) {//遍历strings，把每个地方都绘制出来，
                ...
                if (i == 0) {
                    ...
                    LogUtils.i("HorizontalselectedView-----------ABCDE-------------------->" + strings.get(i));
                }
     ...
     */
    public void setData(List<String> strings,int one) {
        this.strings = strings;
        n =one-1;   //设置数据  首先选中的位置，1：第一个数据
        invalidate();
    }
